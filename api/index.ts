...
import {
  ...
  logProductUpdate
} from "../server/middleware/productValidation";

// Route handlers
import { getProducts as getPublicProducts } from "../server/routes/products";
import { createOrder, getOrder } from "../server/routes/orders";
import {
  getMenu,
  getProduct,
  getMenuStats,
  getSearchSuggestions
} from "../server/routes/public/menu";
import {
  login,
  getProfile,
  changePassword,
...
} from "../server/routes/admin/simple-all";
import {
  reportError,
  getErrors,
  clearErrors,
  getErrorStats
} from "../server/routes/debug";
...
import {
  ...
  toggleOfferFeatured,
  getFeaturedOffers
} from "../server/routes/admin/simple-all.js";

// Database connection (imported only for health checks)
import { db } from "../server/database/connection";
import { neonHealthCheck } from "../server/lib/neon-data-api";
