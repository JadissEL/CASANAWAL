// =====================================================
// CONTACT INFO HANDLERS (≤150 lines)
// =====================================================
...
export const getContactInfo: RequestHandler = async (req, res) => {
  try {
    ...
    // Get recent customer feedback for ratings
    const avgRatings = await getAverageRatings();

    res.json({
      success: true,
      data: {
        restaurant: DEFAULT_RESTAURANT_INFO,
        business_hours: {
...
// Helper functions moved to contact-utils.ts to maintain ≤150 lines
